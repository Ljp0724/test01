package com.ljp.ycu.mybatis.result;
...
public class CodeMsg {
    ...
    public static CodeMsg USERNAME_PASSWORD_ERROR = new CodeMsg(500217, "用户名和密码错误！");
    public static CodeMsg USERNAME_NOT_EXISTS = new CodeMsg(500218, "用户名不存在！");
